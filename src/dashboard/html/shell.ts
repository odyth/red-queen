export type NavKey = "status" | "service" | "config" | "skills" | "workflow" | "cost";
...
export const NAV_TABS: readonly NavTab[] = [
  ...
  { key: "cost", label: "Cost", partialPath: "/api/cost-partial" },
];
...
<!-- Defense in depth: disable htmx's eval / inline-script execution. The
     ...
     and server-provided <script> tags are never intentional. The tab
     controller ships as a static bundle loaded from /assets/controller.js
     so the browser parses it once on initial page load — independent of
     htmx's script-tag policy. -->
<meta name="htmx-config" content='{"allowEval":false,"allowScriptTags":false,"includeIndicatorStyles":true}' />
<style>${STYLES}</style>
<script src="/assets/htmx.min.js" defer></script>
<script src="/assets/controller.js" defer></script>
</head>
<body>
<header>
